...
.input:                  ; handle keyboard input
    ...
    xchg bx, ax          ; set AX to offset of old head position and BX to new offset
    add bx, ax           ;   use XCHG and ADD instead of XADD because emu2 does not support the XADD instruction
